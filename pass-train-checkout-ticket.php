                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                         ...
                         */
                            //$aid=$_SESSION['pass_id'];
                            $ret="SELECT * FROM orrs_passenger WHERE pass_id=? && fare_payment_code = ''";//sql to get details of our user
                            $stmt= $mysqli->prepare($ret) ;
                            $stmt->bind_param('i',$aid);
                            $stmt->execute() ;//ok
                            $res=$stmt->get_result();
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><?php echo $row->deptime;?></td>
                        <td><?php echo $row->arrtime;?></td>
                        <td>₹<?php echo $row->fare;?></td>
                        <td><a href="pass-checkout-ticket.php?pass_id = <?php echo $row->pass_id;?>"><button class="btn btn-success btn-sm">Checkout</button></a></td>
                      </tr>
                        <?php }?>
                    </tbody>
                  </table>
