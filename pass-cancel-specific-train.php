<?php
    ...
    if(isset($_POST['Cancel_Train']))
    {
            ...
            */
            ...
            $query="update  orrs_passenger set train_no = ?, train_name = ?, deptime = ?,  arrtime = ?, fare = ? where pass_id=?";
            $stmt = $mysqli->prepare($query); //prepare sql and bind it later
            $rc=$stmt->bind_param('sssssi', $train_no, $train_name, $deptime, $arrtime, $fare, $aid);
            $stmt->execute();
            if($stmt)
            {
                $succ = "Ticket Cancelled";
            }
            else 
            {
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="train_no" placeholder="<?php echo $row->train_no;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Train Name</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="train_name" placeholder="<?php echo $row->train_name;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="deptime" placeholder="<?php echo $row->deptime;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">My Arrival Time</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="arrtime" placeholder="<?php echo $row->arrtime;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Train Fare</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="fare" placeholder="<?php echo $row->fare;?>"  id="inputText3" type="text">
                      </div>
                    </div>
                    <!--End TRain  isntance-->
                    <?php }?>
