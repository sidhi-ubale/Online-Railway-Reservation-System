<?php
    ...
    if(isset($_POST['add_train']))
    {
            ...
            $query="insert into orrs_train (train_no, train_name, journey_date, route, deptime, arrtime, fare, passengers) values(?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            //bind this parameters
            $rc=$stmt->bind_param('ssssssss', $train_no, $train_name, $journey_date, $route, $deptime, $arrtime, $fare, $passengers);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Train Added";
                  ...
                  <form method ="POST">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="train_no" id="inputText3" type="text" placeholder="Enter Train Number">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3"> Train Name</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="train_name" id="inputText3" type="text" placeholder="Enter Train Name">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Journey Date</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="journey_date" id="inputText3" type="text" placeholder="Enter Journey Date in this format[DD/MM/YY]">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="deptime"  id="inputText3" type="text" placeholder="Enter Source/Departure Time in Format[Hours:Min AM/PM]">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Arrival Time</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="arrtime"  id="inputText3" type="text" placeholder="Enter Destination/Arrival Time">
                      </div>
                    </div>
                    <div class="form-group row">
