              ...
              <div class="card card-table">
                <div class="card-header">Trains
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#"></a><a class="dropdown-item" href="#"></a><a class="dropdown-item" href="#"></a>
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><?php echo $row->journey_date;?></td>
                        <td><?php echo $row->route;?></td>
                        <td class="center"><?php echo $row->deptime;?></td>
                        <td class="center"><?php echo $row->arrtime;?></td>
