<?php
    ...
    if(isset($_POST['add_train']))
    {
            ...
            $query="insert into orrs_train (name, route, journey_date, deptime, arrtime,train_no, fare, passengers) values(?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            //bind this parameters
            $rc=$stmt->bind_param('ssssssss', $name, $route, $journey_date, $deptime, $arrtime, $train_no, $fare, $passengers);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Train Added";
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="deptime"  id="inputText3" type="text" placeholder="Enter Source/Departure Time">
                      </div>
                    </div>
                    <div class="form-group row">
