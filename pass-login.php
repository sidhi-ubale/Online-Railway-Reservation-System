        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="{conf.logoWidth}" height="27"><span class="splash-description">Passenger Login Panel</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; Online Railway Reservation System</div>
          </div>
        </div>
      </div>
    </div>
